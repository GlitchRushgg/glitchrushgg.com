...
const STRINGS = {
  es: {
    ...
    menu: "MENÚ",
    share: "COMPARTIR",
    shareText: "Sobreviví {t} al enjambre en RICOCHET RUSH 🔥 {k} bajas. ¿Puedes superarme?",
    levelUp: "¡NIVEL {n}!",
    ...
    up_bspeed: "BALAS VELOCES", up_bspeed_d: "+20% velocidad de bala",
  ...
  en: {
    ...
    menu: "MENU",
    share: "SHARE",
    shareText: "I survived {t} against the swarm in RICOCHET RUSH 🔥 {k} kills. Can you beat me?",
    levelUp: "LEVEL {n}!",
    ...
    up_bspeed: "SWIFT SHOTS", up_bspeed_d: "+20% bullet speed",
