...
//   tap:  "glow" | "wiggle" | "fish" | "cuckoo" | "radio" | "tree" | "toybox"
//         | "fridge" | "sink"
//   drop: "cook" | "blend" | "lay" | "swing" | "bounce" | "hide" | "eat-spot"
// Garden has no wall: it paints the FENCE instead (handled by HouseScene).
...
export const ROOMS = {
  living: {
    ...
    furniture: [
      ...
      { key: "lamp", x: 118, y: 640, h: 300, tap: "glow" },
      ...
      { key: "toybox", x: 90, y: 700, h: 130, tap: "toybox" },
    ],
  },
  kitchen: {
    floor: "tiles",
    furniture: [
      { key: "fridge", x: 150, y: 650, h: 330, tap: "fridge" },
      { key: "stove", x: 420, y: 650, h: 250, drop: "cook" },
      { key: "sink", x: 660, y: 650, h: 240, tap: "sink" },
      { key: "blender", x: 810, y: 555, h: 120, drop: "blend", tap: "wiggle" },
      { key: "ktable", x: 1010, y: 668, h: 220, drop: "table" },
      { key: "fruitbowl", x: 1010, y: 505, h: 80, tap: "fruit" },
  ...
  bedroom: {
    ...
    furniture: [
      ...
      { key: "dollhouse", x: 90, y: 655, h: 200, tap: "wiggle" },
      { key: "teddy", x: 520, y: 640, h: 120, tap: "wiggle" },
  ...
  garden: {
    ...
    furniture: [
      ...
      { key: "sandbox", x: 350, y: 705, h: 120, tap: "wiggle", drop: "sit", seat: 0.3 },
      { key: "picnic", x: 660, y: 706, h: 110, drop: "sit", seat: 0.12 },
      { key: "wateringcan", x: 940, y: 690, h: 90, tap: "wiggle" },
      { key: "ball", x: 440, y: 695, h: 80, tap: "wiggle" },
