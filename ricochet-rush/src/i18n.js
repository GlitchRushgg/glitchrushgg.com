...
const STRINGS = {
  es: {
    ...
    best: "Récord",
    coins: "monedas",
    howtoMove: "MUÉVETE: WASD/flechas · APUNTA con el ratón",
    howtoMoveTouch: "Joystick izq = mover · Joystick der = apuntar",
  ...
  en: {
    ...
    best: "Best",
    coins: "coins",
    howtoMove: "MOVE: WASD/arrows · AIM with the mouse",
    howtoMoveTouch: "Left stick = move · Right stick = aim",
