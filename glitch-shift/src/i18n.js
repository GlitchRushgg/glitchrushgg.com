...
const STRINGS = {
  es: {
    ...
    hintShift: "TOCA ARRIBA/ABAJO o ↑↓ para cambiar de carril",
    hintHold: "MANTÉN PULSADO = OVERCLOCK",
    hintDrone: "¡LOS DRONES CAMBIAN DE CARRIL!",
    hintLaser: "¡LÁSER! SAL DE SU CARRIL",
    sector: "SECTOR {n}",
    overclock: "OVERCLOCK",
    paused: "PAUSA",
  ...
  en: {
    ...
    hintShift: "TAP UP/DOWN or ↑↓ to change lane",
    hintHold: "HOLD = OVERCLOCK",
    hintDrone: "DRONES SWAP LANES!",
    hintLaser: "LASER! CLEAR ITS LANE",
    sector: "SECTOR {n}",
    overclock: "OVERCLOCK",
    paused: "PAUSED",
